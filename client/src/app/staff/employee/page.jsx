...
export default function EmployeePage() {
  ...
  const user = {
    name: userData ? `${userData.first_name} ${userData.last_name}` : "Employee",
    email: userData ? userData.email : "employee@alphasystems.com",
  ...
  return (
    <>
      ...
      <div className="flex flex-col min-w-0 overflow-hidden">
        ...
        <SidebarMenuLabel className="text-xs text-sidebar-foreground">Employee Portal</SidebarMenuLabel>
      </div>
    </>
  )
}
