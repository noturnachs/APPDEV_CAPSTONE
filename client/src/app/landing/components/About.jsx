          ...
          >
            ...
            <div className="space-y-3">
              {achievements.map((achievement, index) => (
                ...
                >
                  <CheckCircle className="h-5 w-5 text-[#106934] mt-0.5 flex-shrink-0" />
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {values.map((value, index) => (
            <motion.div
              ...
              className="text-center p-8 rounded-xl bg-gray-50 hover:bg-[#106934]/5 transition-colors duration-300"
            >
              <div className="w-16 h-16 bg-[#106934]/10 rounded-full flex items-center justify-center mx-auto mb-6">
                <value.icon className="h-8 w-8 text-[#106934]" />
              </div>
