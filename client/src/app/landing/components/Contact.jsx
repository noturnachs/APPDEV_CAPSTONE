            ...
            <FadeIn key={index} delay={0.2 * index}>
              <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 h-full !bg-white !border-gray-200">
                <CardContent className="p-6 lg:p-8 text-center flex flex-col h-full">
                  <div className="w-14 h-14 lg:w-16 lg:h-16 bg-[#106934]/10 rounded-full flex items-center justify-center mx-auto mb-4 lg:mb-6 group-hover:bg-[#106934]/20 transition-colors duration-300">
                    <info.icon className="h-6 w-6 lg:h-8 lg:w-8 text-[#106934]" />
                  </div>
