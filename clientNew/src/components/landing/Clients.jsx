    ...
    <section id="clients" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            We're proud to partner with forward-thinking organizations committed
            to environmental excellence and sustainable business practices.
          </motion.p>
        </div>
        ...
        >
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              ...
              across industries achieve their environmental goals and regulatory
              compliance.
            </p>
